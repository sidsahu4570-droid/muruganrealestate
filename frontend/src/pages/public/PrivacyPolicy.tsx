  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12 lg:py-20 space-y-8">
      <SEO
        ...
        description="Learn how Murugan Real Estate protects client transaction metadata and private financial files."
      />
      <div>
      ...
      <Card className="text-xs text-slate-500 leading-relaxed space-y-4 font-sans">
        ...
        <p>
          Murugan Real Estate curates premium real estate transactions. In organizing purchase/rent advisory, we collect names, emails, contact numbers, and optional assets files to perform security checks and model portfolios.
        </p>
        ...
        <p>
          Murugan Real Estate employs TLS encryption, password hashing, and tokenized APIs to safeguard credential keys and prevent database security intrusions.
        </p>
      </Card>
    </div>
  );
